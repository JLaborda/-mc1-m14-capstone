...
# LAYOUT
app.layout = html.Div([
    html.H1('Jorge Laborda - Dashboard Social Networks', style={
    ...
    ], style={"columnCount": 3, 'textAlign': "center",  "margin-right": "20px", "margin-left": "20px"}),
    ...
    ], style={"columnCount": 2, 'textAlign': "center",  "margin-right": "20px", "margin-left": "20px"}),
